...
// with the unieai service. The methods of the [Client] type correspond to
// the unieai REST API as described in [the API documentation].
// The unieai command-line client itself uses this package to interact with
// the backend service.
//
// # Examples
//
...
// repository].
//
// [the API documentation]: https://github.com/nctu6/unieai/blob/main/docs/api.md
// [in the GitHub repository]: https://github.com/nctu6/unieai/tree/main/examples
package api
...
// Client encapsulates client state for interacting with the unieai
...
// environment variable UNIEAI_HOST, which points to the network host and
// port on which the unieai service is listenting. The format of this variable
// is:
//
//	<scheme>://<host>:<port>
//
// If the variable is not specified, a default unieai host and port will be
// used.
...
func (c *Client) do(ctx context.Context, method, path string, reqData, respData any) error {
	...
	request.Header.Set("User-Agent", fmt.Sprintf("unieai/%s (%s %s) Go/%s", version.Version, runtime.GOARCH, runtime.GOOS, runtime.Version()))
...
// Pull downloads a model from the unieai library. fn is called each time
...
// Push uploads a model to the model library; requires registering for unieai.ai
...
//
// [Modelfile]: https://github.com/nctu6/unieai/blob/main/docs/modelfile.md
...
// Version returns the Unieai server version as a string.
