...
func (e StatusError) Error() string {
	...
	default:
		...
		return "something went wrong, please see the unieai server logs for details"
	}
}
...
type GenerateRequest struct {
	// Model is the model name; it should be a name familiar to Unieai from
	// the library at https://unieai.com/library
