...
func TestIntegrationConcurrentPredictOrcaMini(t *testing.T) {
	...
	if s := os.Getenv("UNIEAI_MAX_VRAM"); s != "" {
...
func TestMultiModelStress(t *testing.T) {
	s := os.Getenv("UNIEAI_MAX_VRAM") // TODO - discover actual VRAM
	if s == "" {
		t.Skip("UNIEAI_MAX_VRAM not specified, can't pick the right models for the stress test")
	}
